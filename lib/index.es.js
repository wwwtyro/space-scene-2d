...
(function(module, exports) {
  (function(root, factory) {
    ...
    Alea2.importState = function(i) {
      var random = new Alea2();
...
var pasteFragment = "precision highp float;\nuniform sampler2D texture;\nuniform vec2 resolution;\n\nvoid main() {\n  vec2 xy = gl_FragCoord.xy / resolution;\n  gl_FragColor = texture2D(texture, xy);\n}\n";
var accumulateFragment = "precision highp float;\nuniform sampler2D incidentTexture, lightTexture;\nuniform vec2 resolution;\n\nvoid main() {\n  vec2 uv = gl_FragCoord.xy / resolution;\n  vec3 incident = texture2D(incidentTexture, uv).rgb;\n  vec4 light = texture2D(lightTexture, uv);\n  gl_FragColor = vec4(incident * exp(-light.a) + light.rgb, 1.0);\n}\n";
class Space2D {
  constructor() {
    __publicField(this, "canvas");
    __publicField(this, "regl");
    __publicField(this, "renderStars");
    __publicField(this, "renderBackground");
    __publicField(this, "renderNebula");
    __publicField(this, "renderStar");
    __publicField(this, "paste");
    __publicField(this, "accumulate");
    __publicField(this, "pingpong");
    __publicField(this, "fbLight");
    __publicField(this, "starPositionTexture");
    __publicField(this, "starColorTexture");
    ...
    this.renderStar = this.regl({
      ...
      uniforms: {
        ...
        color: this.regl.prop("color"),
        diffractionSpikeFalloff: this.regl.prop("diffractionSpikeFalloff"),
        diffractionSpikeScale: this.regl.prop("diffractionSpikeScale"),
        scale: this.regl.prop("scale"),
        falloff: this.regl.prop("falloff"),
        offset: this.regl.prop("offset"),
        resolution: this.regl.prop("resolution")
  ...
  render(width, height, options = {}) {
    const opts = __spreadValues(__spreadValues({}, renderConfigDefaults()), options);
